...
📅 Data as of: <i>{time_ago_str}</i>
🤖 QuantTrackerBot

<i>This content is generated by AI and is for informational purposes only. It does not constitute financial or investment advice.</i>
"""
    # 5. 组合完整消息
